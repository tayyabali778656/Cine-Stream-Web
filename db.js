...
function getCollection(name) {
  if (!db) {
    throw new Error('Database is not connected. All reads/writes will fail. Please check if MONGODB_URI environment variable is configured correctly in Vercel settings.');
  }
