...
async function main() {
  ...
  // Let's check if page 2 exists
  const statusPage2 = await new Promise((resolve) => {
    https.get(`https://toon-stream.site/series/one-piece/page/2/`, {
      headers: {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36',
      }
    }, (res) => resolve(res.statusCode));
  });
  console.log("Status of page/2/:", statusPage2);
}
